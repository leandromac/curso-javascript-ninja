(function(){
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Leandro Feitosa Macedo')); 
  ...
  */
  ...
  console.log(text.replace(/brasileiro/g,'juazeirense'));
  ...
  */
  ...
  console.log(text.replace(/[D-Dh-h]/g, 0));
