(function(){
  ...
  */
  ...
  let justMod20r3 = justNumbers.filter(function(item) {
  ...
  */
  console.log( '\nOperation:' );
  let operation = justMod20r3.reduce(function(acumulado,atual) {
  ...
  */
  console.log( '\nOperation 2:' );
  let operation2 = justMod20r3.reduceRight(function(acumulado,atual) {
    return (acumulado + 1) * atual;
  }, 0);
