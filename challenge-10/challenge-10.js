...
var operation = {
  ...
  */
  ...
  if(multiplication) {
    number1 = 4;
    number2 = 9;
    console.log(showOperationsMessage(operationSignal,number1,number2), multiplication(number1,number2));
  }
  else {
    console.log(showErrorMessage(operationSignal));
  }
  ...
  if(division) {
    number1 = 3;
    number2 = 6;
    console.log(showOperationsMessage(operationSignal,number1,numbe2),division(number1,number2));
  }
  else {
    console.log(showErrorMessage(operationSignal));
  }
  ...
  if(mod) {
    number1 = 50;
    number2 = 6;
    console.log(showOperationsMessage(operationSignal,number1,numbe2),mod(number1,number2));
  }
  else {
    console.log(showErrorMessage(operationSignal));
  }
